...
erasor = pygame.transform.scale(pygame.image.load(r"C:\Users\ASER\Desktop\pp2\week8\stuff\eraser.png"), (40, 40))
    ...
    while True :
        ...
        if e.type == pygame.KEYDOWN:
            ...
            if e.key == pygame.K_q:
                ...
                pygame.draw.polygon(screen, color, ((spot[0], spot[1]), (spot[0] + 50, spot[1] + 100), (spot[0] - 50, spot[1] + 100)))
            elif e.key == pygame.K_y: # rhombus
                pygame.draw.polygon(screen, color, ((spot[0], spot[1]), (spot[0] + 50, spot[1] + 100), (spot[0] - 50, spot[1] + 100)))
                pygame.draw.polygon(screen, color, ((spot[0], spot[1] + 200), (spot[0] + 50, spot[1] + 100), (spot[0] - 50, spot[1] + 100)))
