...
class Brush():
    def __init__(self):
        ...
        self.mode = 'draw'
        self.icon = 'brush'
        self.image = pygame.transform.scale(pygame.image.load(r'C:\Users\ASER\Desktop\pp2\week8\stuff\brush.png'), (100, 100))
    ...
    def update(self):
        self.pos = pygame.mouse.get_pos()
        self.image = pygame.transform.scale(pygame.image.load(f'C:/Users/ASER/Desktop/pp2/week8/stuff/{self.icon}.png'), (50, 50))
        self.rect = self.image.get_rect()
